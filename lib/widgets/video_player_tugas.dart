...
class VideoPlayerTugas extends StatefulWidget {
  final String videoUrl;

  const VideoPlayerTugas({super.key, required this.videoUrl});

  @override
  _VideoPlayerTugasState createState() => _VideoPlayerTugasState();
}

class _VideoPlayerTugasState extends State<VideoPlayerTugas> {
